...
import { useAspect, useVideoTexture, useTexture, useGLTF } from '@react-three/drei'
...
<group scale={1}>
      ...
      <mesh
        ...
        scale={[8.3, 1, 8]}>
          <Suspense fallback={<FallbackMaterial url="/imgPlaceholder/Sonic2.png" />}>
      ...
      <mesh
        ...
        scale={[8.3, 1, 5.5]}>
          <Suspense fallback={<FallbackMaterial url="/imgPlaceholder/Dinosaur2.png" />}>
      ...
      <mesh
        ...
        position={[-42.3,31,-33.5]}
        scale={[8.3, 1, 8]}>
          <Suspense fallback={<FallbackMaterial url="/imgPlaceholder/Samus2.png" />}>
      ...
      <mesh
        ...
        position={[-42.3,48,-33.5]}
        scale={[8.3, 1, 5.5]}>
          <Suspense fallback={<FallbackMaterial url="/imgPlaceholder/Dragonite4.png" />}>
