export const List = [
    ...
    },
    {
        ...
        completeDescription: <><p>Modeled (as a team) a roundabout and a warehouse with agents that took decisions given some rules.</p><p style={{marginTop:"0.6rem"}}>Used Agent-based modeling in Python, and simulated on Unity.</p></>,
