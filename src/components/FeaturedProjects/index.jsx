...
<spotLight position={[0, 0, 40]} angle={0.35} penumbra={1.5} intensity={1.5} castShadow shadow-mapSize-width={256} shadow-mapSize-height={256} />
        ...
        <group  position={[0, -3, 0]}>
                ...
                <CardModel rotation-x={-Math.PI/10} scale={downSm ? [140,140,140] : [140,140,140]} position={downSm ? [posGameBoy[0], posGameBoy[1] + 1, posGameBoy[2]] : [posGameBoy[0], posGameBoy[1] + 2, posGameBoy[2] + 6]}/>
