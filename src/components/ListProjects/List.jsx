export const List = [
    ...
    },
    {
        ...
        completeDescription: <><p>Modeled two multi-agent systems as a team. Agents made decisions and interacted with each other.</p><p style={{marginTop:"0.6rem"}}>Used Agent-based modeling in Python, and simulated in Unity.</p></>,
    ...
    { 
        ...
        completeDescription: <><p>Developed (team) a web application that generates data on factors that impact the health of the student community through a monitoring system. </p><p style={{marginTop:"0.6rem"}}>Created a dashboard to view and interact with the metrics of the student flow, as well as record environmental variables in real-time.</p><p style={{marginTop:"0.6rem"}}>First place in “Conexión Tec” competition in the category "Software Prototype Development."</p></>,
    ...
    { 
        ...
        completeDescription: <><p>Developed (team) the Back-End for a link shortener that manages the information from the Roborregos robotics team.</p></>,
